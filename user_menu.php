            ...
            <table class="menu">
                <tr>
                    <td colspan="3" align="center">
                        <a href="request_menu.php">Request Menu</a>
                    </td>
                </tr>
            </table>
        </form>
                    ...
                    for ($i = 1; $i <= 7; $i++) {
                        if ($dayOfWeek >= $firstDayOfMonth && $currentDate <= $lastDayOfMonth) {
                            ...
                            if ($total_menu_row) {
                                ...
                                echo '<td bgcolor="lightblue">' . $currentDate . '<a href="user_detail_menu.php?date=' . urlencode($formattedDate) . '">Detail Menu</a></td>';
                                $currentDate++;
                                ...
                                // Membuat URL dengan menggunakan objek tanggal
                                echo '<td>' . $currentDate . '<a href="request_menu.php?date=' . urlencode($formattedDate) . '">Request Menu</a></td>';
                                $currentDate++;
                            }
                        } else {
                            echo '<td></td>';
