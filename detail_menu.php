...
if (isset($_POST['edit'])) {
    ...
    if ($hitmakanan == 0) {
        ...
        $update_menu = mysqli_query($koneksi, "UPDATE menu SET qty ='$qty', total_menu= '$total' WHERE id_menu = '$id_menu_edit'");
...
$_SESSION['tanggal'] = $detail_tanggal;

$_SESSION['from'] = 'detail_menu.php';
                ...
                <form action="" method="post">
                    <table class="table">
                        <tr>
                            <td>Tanggal</td>
                            <td>:</td>
                            <td><input type="date" name="tanggal" value="<?= $detail_tanggal ?>" required readonly></td>
                        </tr>
                        <tr>
                            <td>Banyak</td>
                            <td>:</td>
                    ...
                    <table class="button-container">
                        ...
                        <tr>
                            <td align="center" class="back"><a href="menu.php">Kembali</a></td>
                        </tr>
                    </table>
                </form>
            </div>
