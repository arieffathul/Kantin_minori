...
if (isset($_GET['terima'])) {
    ...
    mysqli_query($koneksi, "UPDATE makanan SET status = 'acc' WHERE id_makanan ='$_GET[terima]'");
    echo "<script>
...
if (isset($_GET['tolak'])) {
    ...
    mysqli_query($koneksi, "DELETE FROM makanan WHERE id_makanan ='$_GET[tolak]'");
    echo "<script>
...
<body>
    ...
    <!-- List Role -->
    <div class="role">
        <h3><a href="request.php">Makanan</a></h3>
        <h3><a href="request1.php">Menu</a></h3>
    </div>
            ...
            <tbody>
                <?php foreach ($foods as $food) { ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="?terima= <?= $food['id_makanan'] ?>">Terima</a>
                            <a href="?tolak= <?= $food['id_makanan'] ?>" onclick="return konfirmasi(); ">Tolak</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
    ...
    <script>
        function konfirmasi() {
            return confirm('Yakin ingin menolak request ini?');
        }
    </script>
</body>
