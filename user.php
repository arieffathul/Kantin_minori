...
if (isset($_GET['admin'])) {
    ...
    mysqli_query($koneksi, "UPDATE admin SET role = 'admin' WHERE id_admin ='$_GET[admin]'");
    echo "<script>
...
if (isset($_POST['cari'])) {
    ...
    $users = query("SELECT * FROM admin WHERE username LIKE '%$cari%' AND role = 'user' ORDER BY tgl_register ASC");
}
            ...
            <tbody>
                <?php foreach ($users as $user) { ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="?admin= <?= $user['id_admin'] ?>">Ubah Admin</a>
